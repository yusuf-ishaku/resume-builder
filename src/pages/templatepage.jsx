...
export const TemplatePage = () =>{
    ...
    const {firstName, setFirstName} = useContext(UserInputs);
    useEffect(()=>{
            ...
            <section className="w-full flex flex-row fixed">
                <section className="w-[50vw] h-[100vh] bg-gray-900 flex flex-row items-center justify-center">
                    <PDFViewer width={'80%'} height={'90%'} showToolbar={false}>
                        <Resume1 firstName={firstName}></Resume1>
                   </PDFViewer>
                </section>
                <section className="w-[50vw] p-4 pb-5 bg-white drop-shadow-lg">
                    ...
                    <div className="mt-5 grid grid-cols-2 gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input type="text" placeholder="e.g. Software developer" className="p-2 placeholder-gray-400 border-[1px] border-gray-400 rounded-md"/>
                        </div>
                        <div className="flex flex-col">
